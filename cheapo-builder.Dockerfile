...
COPY --from=ghcr.io/jaysonsantos/bunderwar:sccache-0.17.0 /usr/local/bin/sccache /usr/local/bin/
COPY --from=ghcr.io/jaysonsantos/bunderwar:sqlx-cli-0.9.0 /usr/local/bin/ /usr/local/bin/
COPY --from=ghcr.io/jaysonsantos/bunderwar:cargo-zigbuild-0.23.3 /usr/local/bin/ /usr/local/bin/
