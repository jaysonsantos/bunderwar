...
ARG RUSTFS_VERSION=1.0.0-rc.1-preview.1
...
COPY --from=ghcr.io/jaysonsantos/bunderwar:cargo-zigbuild-0.23.3 /usr/local/bin/cargo-zigbuild /usr/local/bin/cargo-zigbuild
