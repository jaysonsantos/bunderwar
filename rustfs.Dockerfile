...
ARG RUSTFS_VERSION=1.0.0-alpha.99
...
COPY --from=ghcr.io/jaysonsantos/bunderwar:cargo-zigbuild-0.22.2 /usr/local/bin/cargo-zigbuild /usr/local/bin/cargo-zigbuild
