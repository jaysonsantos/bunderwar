...
ARG RUSTFS_VERSION=1.0.0-rc.5-preview.3
...
COPY --from=ghcr.io/jaysonsantos/bunderwar:cargo-zigbuild-0.23.4 /usr/local/bin/cargo-zigbuild /usr/local/bin/cargo-zigbuild
